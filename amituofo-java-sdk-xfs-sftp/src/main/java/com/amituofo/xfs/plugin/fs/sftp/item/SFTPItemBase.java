...
public abstract class SFTPItemBase extends ItemBase<SFTPRootspace> implements FileSystem {
	...
	public SFTPItemBase(SFTPRootspace itemspace) {
		super(itemspace);
...
//	}
	...
	public boolean isFromSameSystem(Item item) {
		if (!(item instanceof SFTPItemBase)) {
			return false;
		}
...
//	}
	...
	public boolean exists() throws ServiceException {
		...
		try {
			...
			SftpATTRS stat = ftpClient.stat(this.getEncodedActualPath());
			return stat != null;
		} catch (Exception e) {
//			throw new ServiceException(e);
			return false;
