...
public class MQEFileItemList implements ItemList<MQEFileItem> {

	private MQEQueryRequest request;

	public MQEFileItemList(MQEQueryRequest request) {
		this.request = request;
	}

	@Override
	public void add(MQEFileItem item) {
	}
	...
	@Override
	public Iterator<MQEFileItem> iterator() {
		return new MQEFileItemIterator(request);
	}

	@Override
	public void updateStatus(MQEFileItem item, int status) {
	}
...
//	@Override
//	public List<MQEFileItem> toList() {
//		return null;
//	}
